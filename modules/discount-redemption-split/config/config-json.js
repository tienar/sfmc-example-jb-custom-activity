  ...
  return {
    ...
    arguments: {
      execute: {
        ...
        url: `https://sfmc-tienar.herokuapp.com/modules/discount-redemption-split/execute`
      }
    },
    configurationArguments: {
      "applicationExtensionKey": "bbff74f0-847e-4527-8dcb-e2ac5c9611f1",
      save: {
        url: `https://sfmc-tienar.herokuapp.com/modules/discount-redemption-split/save`
      },
      publish: {
        url: `https://sfmc-tienar.herokuapp.com/modules/discount-redemption-split/publish`
      },
      validate: {
        url: `https://sfmc-tienar.herokuapp.com/modules/discount-redemption-split/validate`
      },
      stop: {
        url: `https://sfmc-tienar.herokuapp.com/modules/discount-redemption-split/stop`
      }
    },
    userInterfaces: {
      configInspector: {
